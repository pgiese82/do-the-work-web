      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-950 text-white pt-20 min-h-screen flex items-center">
        ...
        <div className="relative container mx-auto px-6 py-20">
          <div className="max-w-5xl mx-auto text-center">
            <Badge className="mb-8 bg-orange-600/20 border border-orange-500/30 hover:bg-orange-600/30 text-orange-200 text-lg px-8 py-3 backdrop-blur-sm">
              #DoTheWork
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group relative overflow-hidden bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white text-xl font-bold px-10 py-5 rounded-xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-2xl hover:shadow-orange-500/25">
                <span className="relative z-10">Start vandaag</span>
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </button>
              <button className="group relative overflow-hidden border-2 border-white/30 hover:border-orange-400 text-white hover:text-orange-300 text-xl font-bold px-10 py-5 rounded-xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 backdrop-blur-sm bg-white/5 hover:bg-white/10">
