...
const AboutSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 xl:py-32 bg-white" id="over-mij">
      <div className="container mx-auto px-4 md:px-8 lg:px-12 xl:px-16">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-20 items-center max-w-7xl mx-auto">
          <div ref={contentRef} className={`order-2 lg:order-1 scroll-fade-in ${contentVisible ? 'visible' : ''}`}>
            ...
            <p className="text-base md:text-lg lg:text-xl text-slate-600 mb-6 md:mb-8 lg:mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 md:gap-8 mb-6 md:mb-8 lg:mb-10">
              <div className="flex -space-x-2">
                {[1,2,3,4,5].map((i) => (
                  <div key={i} className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full bg-orange-500 border-2 md:border-4 border-white flex items-center justify-center">
