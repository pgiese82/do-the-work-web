...
-- Fix the bulk_update_bookings function to handle all fields including date_time
  ...
  LOOP
    ...
    SET 
      ...
      attendance_status = CASE 
        WHEN update_data->>'attendance_status' IS NULL THEN NULL
        WHEN update_data->>'attendance_status' = '' THEN NULL
